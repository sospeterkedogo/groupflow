...
export default function SettingsPage() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, type: 'avatar' | 'bg') => {
    try {
      ...
      const { error: uploadError } = await supabase.storage.from('FlowSpace_assets').upload(fileName, compressedFile, { upsert: true })
      if (uploadError) throw uploadError

      const { data } = supabase.storage.from('FlowSpace_assets').getPublicUrl(fileName)
      ...
      <div style={{ minHeight: '400px' }}>
        ...
        {activeTab === 'support' && (
          <div className="auth-card" style={{ maxWidth: '100%' }}>
            ...
            <p style={{ color: 'var(--text-sub)', marginBottom: '2.5rem' }}>Tell us how we can make FlowSpace better for your team.</p>
        ...
        {activeTab === 'data' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div className="auth-card" style={{ maxWidth: '100%' }}>
              ...
              <p style={{ color: 'var(--text-sub)', marginBottom: '2rem' }}>Audit and export your activity within the FlowSpace ecosystem.</p>
        ...
        <div className="modal-overlay" style={{ zIndex: 9999 }}>
          <div className="modal-content" style={{ maxWidth: '450px', textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-sub)', fontSize: '0.95rem', marginBottom: '2rem', lineHeight: 1.6 }}>
              This will <strong>permanently delete</strong> your FlowSpace account and all associated data. This action cannot be undone.
            </p>
            <input
