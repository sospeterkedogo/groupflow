...
export default function FeaturesDocs() {
  const features = [
    ...
    },
    {
      ...
      title: 'Team Chat',
      eli12: "Instant messaging built right into your project. You can talk to your team without ever leaving GroupFlow."
    },
    {
      icon: <Zap size={24} />,
      title: 'Presence Dots',
    ...
    <div className="docs-content">
      <div style={{ marginBottom: '4rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: '1.5rem' }}>
          All GroupFlow Features
        </h1>
        <p style={{ fontSize: '1.1rem', color: '#9ca3af', lineHeight: 1.6 }}>
          Explore every capability of the GroupFlow ecosystem. We've explained everything in simple terms 
