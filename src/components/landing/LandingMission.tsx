       ...
       <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '6rem', alignItems: 'center' }} className="grid-responsive">
          <div>
             ...
             <p style={{ fontSize: '1.125rem', color: '#9ca3af', lineHeight: 1.7, marginBottom: '3rem' }}>
                Standard tools often miss how hard you actually work in a group. Espeezy was built to make sure everyone—from the ones doing the research to the ones putting it all together—gets recognized for their role.
             </p>
...
<<<<<<< HEAD
                <div style={{ width: '42px', height: '42px', background: 'linear-gradient(145deg, #070707 0%, #131313 100%)', border: '1px solid rgba(212, 160, 23, 0.35)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 20px rgba(212, 160, 23, 0.12)' }}>
                   <img src="/brand-logo-black-gold.svg" style={{ width: '24px', height: '24px', objectFit: 'contain' }} alt="Espeezy" />
=======
