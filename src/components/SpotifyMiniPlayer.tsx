        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ 
            ...
            {currentTrack?.album.images[0]?.url ? (
              <img src={currentTrack.album.images[0].url} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            ) : (
          ...
          <div style={{ 
            ...
            <span style={{ fontSize: '0.65rem', fontWeight: 900, color: '#1DB954' }}>Syncing</span>
          </div>
        </div>
