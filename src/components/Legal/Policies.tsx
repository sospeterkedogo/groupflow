...
export const PrivacyPolicy = ({ onClose }: { onClose: () => void }) => (
  <PolicyContainer title="Privacy Policy" onClose={onClose}>
    ...
    <p>FlowSpace collects the minimum data required to facilitate educational collaboration. This includes your email, full name, and school ID. We do not sell your data to third parties.</p>
...
export const TermsOfService = ({ onClose }: { onClose: () => void }) => (
  <PolicyContainer title="Terms of Service" onClose={onClose}>
    ...
    <p>FlowSpace is designed to promote honest collaboration. By using this service, you agree to submit only your original work and accurately report your contributions.</p>
