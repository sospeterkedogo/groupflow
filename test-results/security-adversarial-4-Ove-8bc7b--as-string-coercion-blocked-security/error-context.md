...
- Name: security-adversarial.spec.ts >> 4. Oversized Payload & DoS Resistance >> Amount_cents as string coercion blocked
- Location: tests\security-adversarial.spec.ts:367:7
...
Expected value: 500
Received array: [400, 401, 403, 429]
```
