...
- Name: security-adversarial.spec.ts >> 1. Security Response Headers >> X-Content-Type-Options prevents MIME sniffing
- Location: tests\security-adversarial.spec.ts:113:7

# Error details

```
Error: X-Content-Type-Options missing
