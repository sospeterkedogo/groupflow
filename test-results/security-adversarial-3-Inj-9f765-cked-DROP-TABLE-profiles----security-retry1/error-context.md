...
- Name: security-adversarial.spec.ts >> 3. Injection Attack Resistance >> 3a. SQL Injection via public pre-registration endpoint >> SQL injection blocked: '; DROP TABLE profiles;--
