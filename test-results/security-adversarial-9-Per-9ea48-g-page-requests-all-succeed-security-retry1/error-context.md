...
- Name: security-adversarial.spec.ts >> 9. Performance & Availability (SLA Targets) >> 10 concurrent landing page requests all succeed
- Location: tests\security-adversarial.spec.ts:581:7

# Error details

```
Error: 10 concurrent requests failed

expect(received).toHaveLength(expected)

Expected length: 0
Received length: 10
Received array:  [{"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}, {"ok": false, "status": 500}]
```
