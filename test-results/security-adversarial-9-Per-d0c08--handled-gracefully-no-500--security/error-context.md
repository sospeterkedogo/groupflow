...
- Name: security-adversarial.spec.ts >> 9. Performance & Availability (SLA Targets) >> 404 page handled gracefully (no 500)
- Location: tests\security-adversarial.spec.ts:591:7
