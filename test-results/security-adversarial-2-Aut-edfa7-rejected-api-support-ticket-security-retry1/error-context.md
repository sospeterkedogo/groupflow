...
- Name: security-adversarial.spec.ts >> 2. Authentication & Authorisation Bypass >> Unauthenticated GET rejected: /api/support/ticket
- Location: tests\security-adversarial.spec.ts:161:9

# Error details

```
Error: /api/support/ticket must reject unauthenticated requests (got 500)
