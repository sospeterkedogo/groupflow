...
- Name: security-adversarial.spec.ts >> 10. Input Validation & Data Integrity >> Pre-registration rejects array as email
- Location: tests\security-adversarial.spec.ts:646:7
