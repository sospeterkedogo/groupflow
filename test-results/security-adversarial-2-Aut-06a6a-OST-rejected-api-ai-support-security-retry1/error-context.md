...
- Name: security-adversarial.spec.ts >> 2. Authentication & Authorisation Bypass >> Unauthenticated POST rejected: /api/ai/support
- Location: tests\security-adversarial.spec.ts:169:9

# Error details

```
Error: /api/ai/support POST must reject unauthenticated requests (got 500)
