...
- Name: security-adversarial.spec.ts >> 9. Performance & Availability (SLA Targets) >> Pre-registration GET responds under 800ms
- Location: tests\security-adversarial.spec.ts:575:7
