...
- Name: security-adversarial.spec.ts >> 5. Path Traversal & IDOR Resistance >> Admin task route blocks non-admin by UUID
- Location: tests\security-adversarial.spec.ts:407:7
