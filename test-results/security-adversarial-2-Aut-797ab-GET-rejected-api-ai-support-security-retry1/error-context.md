...
- Name: security-adversarial.spec.ts >> 2. Authentication & Authorisation Bypass >> Unauthenticated GET rejected: /api/ai/support
- Location: tests\security-adversarial.spec.ts:161:9

# Error details

```
Error: /api/ai/support must reject unauthenticated requests (got 500)
