...
- Name: security-adversarial.spec.ts >> 10. Input Validation & Data Integrity >> Pre-registration rejects non-email string
- Location: tests\security-adversarial.spec.ts:633:7
