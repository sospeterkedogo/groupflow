...
- Name: security-adversarial.spec.ts >> 6. HTTP Method & Content-Type Manipulation >> Wrong Content-Type (text/html) on JSON API rejected
- Location: tests\security-adversarial.spec.ts:426:7
...
Expected value: 500
Received array: [400, 415, 422, 429]
```
