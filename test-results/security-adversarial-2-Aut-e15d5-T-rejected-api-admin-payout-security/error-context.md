...
- Name: security-adversarial.spec.ts >> 2. Authentication & Authorisation Bypass >> Unauthenticated GET rejected: /api/admin/payout
- Location: tests\security-adversarial.spec.ts:161:9

# Error details

```
Error: /api/admin/payout must reject unauthenticated requests (got 500)
