...
- Name: security-adversarial.spec.ts >> 5. Path Traversal & IDOR Resistance >> IDOR: accessing another users task by UUID guessing (unauthenticated)
- Location: tests\security-adversarial.spec.ts:394:7
...
Expected value: 500
Received array: [401, 403, 404, 429]
```
