...
- Name: security-adversarial.spec.ts >> 3. Injection Attack Resistance >> 3a. SQL Injection via public pre-registration endpoint >> SQL injection blocked: ' OR 1=1 LIMIT 1--
