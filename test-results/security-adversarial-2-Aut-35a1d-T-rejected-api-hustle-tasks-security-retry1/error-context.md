...
- Name: security-adversarial.spec.ts >> 2. Authentication & Authorisation Bypass >> Unauthenticated GET rejected: /api/hustle/tasks
- Location: tests\security-adversarial.spec.ts:161:9

# Error details

```
Error: /api/hustle/tasks must reject unauthenticated requests (got 500)
