...
- Name: security-adversarial.spec.ts >> 4. Oversized Payload & DoS Resistance >> 100KB+ body in pre-registration rejected
- Location: tests\security-adversarial.spec.ts:312:7
...
Expected value: 500
Received array: [400, 413, 422, 429]
```
