...
- Name: security-adversarial.spec.ts >> 2. Authentication & Authorisation Bypass >> Unauthenticated POST rejected: /api/hustle/tasks
- Location: tests\security-adversarial.spec.ts:169:9

# Error details

```
Error: /api/hustle/tasks POST must reject unauthenticated requests (got 500)
